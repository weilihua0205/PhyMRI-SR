...
class ContinuousGaussian(nn.Module):
    ...
    def __init__(self, encoder_spec, cnn_spec, fc_spec, **kwargs):
        ...
        # Option B: Selective merge - combine key components
    ...
    def query_output(self, inp, scale):
        ...
        temperature = 1.0  # Adjust this: higher = more diverse selection (try 2.0-5.0 if unstable)
        ...
        for i in range(bs):
            ...
            min_cholesky = 0.01  # Minimum standard deviation in normalized coordinates
