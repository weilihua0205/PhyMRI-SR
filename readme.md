...
### Pretrained model
- Static-resolution experiments on real 64mT-3T dataset: [model_static_experiment](https://drive.google.com/file/d/15X4U_0wSmW8dtETTQPSBZmUlXCzU4nQC/view?usp=drive_link)
